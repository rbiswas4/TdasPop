...
class SersicSamples(object):
    ...
    def sampleAngles(a, b, numSamples=1, rng=np.random.RandomState()):
        ...
        .. note:: The two lengh parameters a and b need to have the same unit.
            ...
            quadrants from the two that are in the range of arctan. Use the uniform
            distribution of the parameter phi, such that x = a cos(phi),
            y = b sin(phi), such that a tan(theta) = b tan(phi)
        """
